<nav class="navbar navbar-expand-lg navbar-light custom-bg">
  <a class="navbar-brand" href="/hospital-management-system/home">
   ...
   <i><b><span class="text-color">Lifeline care</span></b></i>
  </a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="resources/images/phonee.png" style="width:27px;" alt="img">+91 8937864791 / +91 9456444774 / +91 8941001217<br>
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">Vandana1411singh@gmail.com<br>
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">niveditaagrawal30@gmail.com<br>
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">Utkarsh.msn@gmail.com
            </b>
        </p>
        </div>
      </div>
